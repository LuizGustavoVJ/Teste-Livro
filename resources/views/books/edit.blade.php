                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error("price") is-invalid @enderror"
                                       id="price" name="price" value="{{ old("price", $book->price) ? number_format(old("price", $book->price), 2, ',', '.') : '' }}" required
                                       placeholder="R$ 0,00" autocomplete="off">
                                @error("price")
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle me-1"></i>Digite apenas números (ex: 1234.56 será formatado como R$ 1.234,56)
                                </small>
                            </div>
                        </div>
                        <div class="col-md-4">
